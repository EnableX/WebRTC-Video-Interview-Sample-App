...
config.SERVER_API_SERVER = {
  host: "api.enablex.io" /* Server API URL. Change it to connect to right EnableX Cluster */,
  port: "443",
  /* Server API Port. */
};
...
// SSL CERTIFICATES: To ensure secured communication between End Point sand this Service, its required to
// host it on a Domain or Sub-Domain name. Client End Points would stay connected using Secured Web Sockets
// Use path to the files relative to Server Directory
...
config.appPort = 8443; /* Service Port */
...
config.maxHunt = 3; /* Max retries to hung available agent, before moving to SUBMIT QUERY form */
